...
class Settings(BaseSettings):
    ...
    ELEVENLABS_API_KEY_SECONDARY: str = os.getenv("ELEVENLABS_API_KEY_SECONDARY", "")
    ELEVENLABS_API_KEY_TERTIARY: str = os.getenv("ELEVENLABS_API_KEY_TERTIARY", "")
    ELEVENLABS_API_KEY_QUATERNARY: str = os.getenv("ELEVENLABS_API_KEY_QUATERNARY", "")
    ELEVENLABS_API_KEY_QUINARY: str = os.getenv("ELEVENLABS_API_KEY_QUINARY", "")
    ELEVENLABS_API_KEY_SENARY: str = os.getenv("ELEVENLABS_API_KEY_SENARY", "")
